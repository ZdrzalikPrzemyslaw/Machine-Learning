...
class NeuralNetwork:
    ...
    def funkcja_liniowa(self, inputcik):
        return inputcik
    ...
    def calculate_outputs(self, inputs):
        ...
        output_layer_output = self.funkcja_liniowa(numpy.dot(hidden_layer_output, self.output_layer))
...
def main():
    # print(wczytajPunktyZPliku("approximation_train_1.txt"))
    # print(wczytajPunktyZPliku("approximation_train_1.txt").shape)
    # print(wczytajPunktyZPliku("approximation_train_1.txt")[:,0].shape)
    # print(numpy.reshape(wczytajPunktyZPliku("approximation_train_1.txt")[:,0], (81, 1)).shape)
    # print(numpy.reshape(wczytajPunktyZPliku("approximation_train_1.txt")[:,1], (81, 1)))
    # print(wczytajPunktyZPliku("approximation_train_1.txt")[:,1].shape)
    siec = NeuralNetwork(20, 1, 1)
    # print(siec)
    siec.train(numpy.reshape(wczytajPunktyZPliku("approximation_train_1.txt")[:,0], (81, 1)), numpy.reshape(wczytajPunktyZPliku("approximation_train_1.txt")[:,1], (81, 1)), 10000)
    # print(siec)
    print(siec.calculate_outputs(numpy.reshape(wczytajPunktyZPliku("approximation_train_1.txt")[:,0], (81, 1))))
